...
set_attr source_files [list src/processor.cc] [get_design]
set_attr compile_flags " -w -I src -DCTOS -D__CTOS__ -D_CTOS_" [get_design]
set_attr top_module_path "Processor" [get_design]
define_clock -name clk -period 3500 -rise 0 -fall 1750
