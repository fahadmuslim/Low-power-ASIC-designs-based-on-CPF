...
current_design topmodule_rtl

# create_clock -name "main_clk" -add -period 5.5 -waveform {0.0 2.75} [get_ports clk]
create_clock -name "main_clk" -add -period 15 -waveform {0.0 7.5} [get_ports clk]
